...
class LapStyleDraXDOG(BaseModel):
    def __init__(self,
        ...
        self.gaussian_filter_2.set_state_dict({'weight':gaussian(10,.6*2)})
        self.morph_conv = paddle.nn.Conv2D(3,3,6,padding=3,groups=1,padding_mode='reflect',bias_attr=False)
