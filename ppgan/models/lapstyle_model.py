...
class LapStyleDraXDOG(BaseModel):
    def __init__(self,
        ...
        self.content_weight = content_weight
        self.style_weight = style_weight
        self.gaussian_filter = paddle.nn.Conv2D(1, 1,3,
        ...
        self.gaussian_filter_2 = paddle.nn.Conv2D(1, 1,3,
                                groups=1, bias_attr=False,
                                weight_attr=paddle.ParamAttr(initializer=paddle.nn.initializer.Normal(mean=.5,std=1.6),trainable=False),
                                padding=1, padding_mode='reflect')
