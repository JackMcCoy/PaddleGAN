...
class LapStyleDraThumbModel(BaseModel):
    ...
    def backward_Dec(self):
        ...
        self.loss = self.loss_ps * self.style_weight *1.25 + self.loss_content_p * self.content_weight +\
...
class LapStyleRevFirstThumb(BaseModel):
    ...
    def backward_G(self, optimizer):
        ...
        self.patch_loss = self.loss_Gp_GAN +self.loss_ps * self.style_weight *1.2 +\
