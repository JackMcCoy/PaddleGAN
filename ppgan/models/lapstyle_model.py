...
def xdog(im, g, g2,morph_conv,gamma=0.92, phi=200, eps=-0.1, k=1.6):
...
class LapStyleDraXDOG(BaseModel):
    def __init__(self,
        ...
        self.gaussian_filter = paddle.nn.Conv2D(1, 1,10,
                                ...
                                weight_attr=paddle.ParamAttr(initializer=paddle.nn.initializer.Normal(mean=0,std=.6),trainable=False),
                                padding=4, padding_mode='reflect')
        self.gaussian_filter_2 = paddle.nn.Conv2D(1, 1,10,
                                groups=1, bias_attr=False,
                                weight_attr=paddle.ParamAttr(initializer=paddle.nn.initializer.Normal(mean=0,std=.6*1.55),trainable=False),
                                padding=4, padding_mode='reflect')
