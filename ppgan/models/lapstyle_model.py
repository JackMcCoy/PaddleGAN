...
class LapStyleRevFirstThumb(BaseModel):
    ...
    def forward(self):
        ...
        p_stylized_up = paddle.slice(stylized_up_2,axes=[2,3],starts=[(positions[2][1]*4).astype('int32'),(positions[2][0]*4).astype('int32')],\
                             ends=[(positions[2][3]*4).astype('int32'),(positions[2][2]*4).astype('int32')])
