    ...
    def test_iter(self, output_dir=None,metrics=None):
        ...
        with paddle.no_grad():
            ...
            if small_side==self.stylized_up.shape[-1]:
                ...
                ranges_x=list(range(0,size_x,move_x))+list(range(math.floor(size_x*.25),size_x-self.in_size_x,move_x))
                size_y = 512
                self.in_size_y = 256
                move_y = 256
                ...
                ranges_y=list(range(0,size_y,move_y))+list(range(math.floor(size_y*.25),size_y-self.in_size_y,move_y))
            for i in ranges_x:
                print('i='+str(i))
                for j in ranges_y:
                    print(str(i)+', '+str(j))
