...
class LapStyleDraXDOG(BaseModel):
    def __init__(self,
        ...
        self.gaussian_filter = paddle.nn.Conv2D(1, 1,10,
                                ...
                                weight_attr=paddle.ParamAttr(initializer=paddle.nn.initializer.Normal(mean=1,std=1),trainable=False),
                                padding=4, padding_mode='reflect')
        self.gaussian_filter_2 = paddle.nn.Conv2D(1, 1,10,
                                groups=1, bias_attr=False,
                                weight_attr=paddle.ParamAttr(initializer=paddle.nn.initializer.Normal(mean=1,std=1.9),trainable=False),
                                padding=4, padding_mode='reflect')
