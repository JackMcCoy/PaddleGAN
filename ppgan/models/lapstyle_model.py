...
class LapStyleRevFirstThumb(BaseModel):
    ...
    def forward(self):
        ...
        p_stylized_up = paddle.slice(stylized_up_2,axes=[2,3],starts=[(self.positions[1][1]*2).astype('int32'),(self.positions[1][0]*2).astype('int32')],\
    ...
    def backward_G(self, optimizer):
        ...
        self.visual_items['content, rev 2']=self.content_stack[-1]
        with paddle.no_grad():
