...
class LapStyleDraThumbModel(BaseModel):
    ...
    def backward_Dec(self):
        ...
        """content loss"""
        self.loss_c = 0
        self.loss_c = self.calc_content_loss(self.ttF['r41'],self.cF['r41'],norm=True)+\
                      self.calc_content_loss(self.ttF['r51'],self.cF['r51'],norm=True)
        #for layer in self.content_layers:
        ...
        self.loss = self.loss_c * self.content_weight + self.loss_s * self.style_weight +\
                    ...
                    self.l_identity1 * 25 + self.l_identity2 * 1 +\
