    ...
    def backward_G(self,i):
        ...
        if i>0:
            ...
            self.p_loss_style_remd += self.calc_style_emd_loss(
                tpF['r31'], spF['r31']) + self.calc_style_emd_loss(
                tpF['r41'], spF['r41'])
            sX,_ = xdog(reshaped.detach(),self.gaussian_filter,self.gaussian_filter_2,self.morph_conv,morphs=2,minmax=sxminmax)
        ...
        mxdogloss=mxdog_content * .3 + mxdog_content_contraint *100 + mxdog_style * 1500
