...
class LapStyleDraThumbModel(BaseModel):
    ...
    def backward_Dec(self):
        ...
        self.p_style_master_remd = self.calc_style_emd_loss(
        ...
        self.loss = self.loss_c * self.content_weight + self.loss_s * self.style_weight +\
                    ...
                    self.loss_content_relt * 16 + self.p_style_master_remd * 10 + self.p_loss_style_remd * 5 + self.p_loss_content_relt * 16
        self.loss.backward()
