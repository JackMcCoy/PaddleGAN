...
class LapStyleDraXDOG(BaseModel):
    ...
    def backward_Dec(self):
        ...
        stylized_dog,_ = xdog(self.stylized,self.gaussian_filter,self.gaussian_filter_2,self.morph_conv,gamma=self.gamma,morph_cutoff=7,morphs=1)
        ...
        self.loss = self.loss_G_GAN + self.loss_c * self.content_weight + self.style_weight * (self.loss_s+self.loss_style_remd*3)+\
                    ...
                    self.loss_content_relt * 16 + self.map_loss + book_loss + book_loss_s
