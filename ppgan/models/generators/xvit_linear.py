...
class SelfAttention(nn.Layer):
    def __init__(self, dim, heads, causal = False, dim_head = None, blindspot_size = 1, n_local_attn_heads = 16, local_attn_window_size = 16, receives_context = False, dropout = 0.1, attn_dropout = 0.1):
        super().__init__()
