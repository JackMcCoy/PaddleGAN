...
def xdog(im, g, g2,morph_conv,gamma=.97, phi=75, eps=-.05, k=1.6):
...
class LapStyleDraXDOG(BaseModel):
    def __init__(self,
        ...
        self.morph_conv = paddle.nn.Conv2D(1,1,10,padding=4,groups=1,padding_mode='reflect',bias_attr=False)
