...
def xdog(im, g, g2,morph_conv,gamma=.94, phi=200, eps=-.1, diff=False, position=False):
    ...
    passedlow= paddle.multiply((imdiff>= mean).astype('float32'),(morphed>= 8.5).astype('float32'))
